...
def resetPrimaryWCS(fname, ext):
    ...
    This 'OPUS' WCS will also be archived as a separate headerlet, if it was
    not already stored as a headerlet extension, since it has
    ...
    for wkey, wname in wcs_dict.items():
        if wname not in headerlet.get_headerlet_kw_names(f, kw='wcsname'):
            # store this WCS as a headerlet


    # DISTNAME = 'None-None-None' for 'OPUS' solutions
